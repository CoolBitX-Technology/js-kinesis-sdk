    ...
    _toCollectionPage: {
      ...
      value: function _toCollectionPage(json) {
        ...
        return {
          ...
          next: function () {
            return _this._sendNormalRequest(URI(json._links.next.href.replace("http:", "https:"))).then(function (r) {
              return _this._toCollectionPage(r);
            });
          },
          prev: function () {
            return _this._sendNormalRequest(URI(json._links.prev.href.replace("http:", "https:"))).then(function (r) {
              return _this._toCollectionPage(r);
            });
          }
        };
